    ...
    <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white shadow-md flex flex-col">
            ...
            <nav class="flex-1 p-4">
                <a href="{{ route('companies') }}" class="flex items-center font-rajdhani py-3 px-4 rounded font-semibold {{ Request::routeIs('companies') ? 'bg-gray-800 text-white' : 'text-gray-800 hover:bg-gray-100' }}">
                ...
                <a href="{{ route('profile') }}" class="flex font-rajdhani items-center mt-3 py-3 px-4 text-gray-800 hover:bg-gray-100 rounded font-semibold {{ Request::routeIs('profile') ? 'bg-gray-800 text-white' : 'text-gray-800 hover:bg-gray-100' }}">
            ...
            <div class="p-4 border-t">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="w-full ml-4 flex items-center py-2 hover:text-gray-500 rounded hover:bg-gray-50 font-rajdhani font-semibold">
